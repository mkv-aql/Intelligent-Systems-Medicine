        ...
        for images in os.listdir(folder_dir):
            if (images.endswith(".png")):
                ...
                if row[0] == images:
                    print(row[1])
                    if row[1] == "Normal":
                        cv2.imwrite("C:/Users/Makav/Desktop/ISM_2022w/train_normal/" + images, image)
                        break
                    if row[1] == "Lung_Opacity":
                        cv2.imwrite("C:/Users/Makav/Desktop/ISM_2022w/train_lung_opacity/" + images, image)
                        break
                    if row[1] == "pneumonia":
                        cv2.imwrite("C:/Users/Makav/Desktop/ISM_2022w/train_pneumonia/" + images, image)
                        break
                    if row[1] == "COVID":
                        cv2.imwrite("C:/Users/Makav/Desktop/ISM_2022w/train_covid/" + images, image)
                        break